...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signup = function (userInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var username, password, name, salt, passwordHashed, userRecord;
    ...
    AuthService.prototype.login = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var userRecord, correctPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!userRecord) {
                            ...
                            correctPassword = bcryptjs_1.default.compareSync(password, userRecord.password);
                            if (!correctPassword) {
